...
adif = open(r'.\textos\cedex.txt' , encoding='UTF8')
#adif = open(r'.\textos\adif.txt' , encoding='UTF8')
...
salida = open(r'.\textos\oposicion_out_auto_cedex_jaccard.txt' , 'w', buffering=1, encoding='UTF8')
def miPrint(s):
    print( s )
    salida.write(s + '\n')
